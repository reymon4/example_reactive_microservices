...
import com.rh.customers.infrastructure.event.producer.CustomerEvent;
...
import com.rh.customers.application.exception.db.IllegalArgumentsException;
...
public class CustomerServiceImpl implements ICustomerService {
    ...
    public Mono<GetCustomerDTO> createCustomer(CreateCustomerDTO createCustomerDTO) {
        ...
        return Mono.fromCallable(() -> customerRepository.save(convertToEntity(createCustomerDTO))).subscribeOn(Schedulers.boundedElastic())
            ...
            return Mono.empty();
        }).then(customerEventProducer.sendCustomerEvent(new CustomerEvent(customer.getIdentificationNumber(), "CUSTOMER_CREATED", LocalDateTime.now()), customer.getIdentificationNumber()))
    ...
    public Mono<Void> deleteCustomer(String identificationNumber) {
        return Mono.fromCallable(() -> this.customerRepository.findByIdentificationNumber(identificationNumber))
                ...
                .then(customerCacheService.delete(identificationNumber)
                        ...
                        }).then(customerEventProducer.sendCustomerEvent(new CustomerEvent(identificationNumber, "CUSTOMER_DELETED", LocalDateTime.now()), identificationNumber)
