package com.rh.customers.application.rest;

import com.rh.customers.application.service.ICustomerService;
...
public class CustomerController {
    ...
    @PutMapping(value = "/{identificationNumber}")
    ...
    @DeleteMapping(value = "/{identificationNumber}")
